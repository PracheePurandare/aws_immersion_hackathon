...
const Home = () => {
  ...
  return (
	...
	<section className="event-filter-sec" id="event-filter">
		<div className="container">
			<div className="row">
			<div className="col-12"><div className="title-fs28 border-bottom mb-5 pb-3">Upcoming Events</div></div>
				<div className="col-12">
					<Swiper
						modules={[Navigation]}
						navigation
									...
									<div className="row">
											<div className="col-12">
												<div className="row justify-content-between align-items-center">
													<div className="col-6"><div className="eventCatagory">In-Person==</div></div>
													<div className="col-6 text-end"><div className="attendy">L200</div></div>
												</div>
											</div>
											<div className="col-12">
